        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DataAssigned = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentAssignments", x => new { x.AssignmentsId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_StudentAssignments_Assignments_AssignmentsId",
                        column: x => x.AssignmentsId,
                        principalTable: "Assignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentAssignments_Students_StudentsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAssignments_StudentsId",
